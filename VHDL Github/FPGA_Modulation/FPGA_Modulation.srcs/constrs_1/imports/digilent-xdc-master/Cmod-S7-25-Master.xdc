...
set_property -dict { PACKAGE_PIN L1    IOSTANDARD LVCMOS33 } [get_ports { lcd_tx }]; #IO_L18N_T2_34 Sch=pio[01]
...
#set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports {  }]; #IO_L11P_T1_SRCC_14 Sch=pio[16]
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { dac_ldac }]; #IO_L11N_T1_SRCC_14 Sch=pio[17]
#set_property -dict { PACKAGE_PIN N13   IOSTANDARD LVCMOS33 } [get_ports {  }]; #IO_L8N_T1_D12_14 Sch=pio[18]
set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports { chip_select }]; #IO_L10N_T1_D15_14 Sch=pio[19]
#set_property -dict { PACKAGE_PIN N14   IOSTANDARD LVCMOS33 } [get_ports {  sample_tick_out }]; #IO_L10P_T1_D14_14 Sch=pio[20] DONE.......
set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { spi_sclk }]; #IO_L9N_T1_DQS_D13_14 Sch=pio[21]
#set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { pio22 }]; #IO_L9P_T1_DQS_14 Sch=pio[22]
set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS33 } [get_ports { spi_mosi }]; #IO_L4N_T0_D05_14 Sch=pio[23] DONE..........
set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports { serial_data_out }]; #IO_L7N_T1_D10_14 Sch=pio[26]
...
#set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { chip_select }]; #IO_L8P_T1_D11_14 Sch=pio[30]
...
set_property -dict { PACKAGE_PIN B2    IOSTANDARD LVCMOS33 } [get_ports { sample_tick_out }]; #IO_L2P_T0_34 Sch=pio[42]
...
set_property -dict { PACKAGE_PIN A4    IOSTANDARD LVCMOS33 } [get_ports { trigger_in }]; #IO_L1P_T0_34 Sch=pio[48]
