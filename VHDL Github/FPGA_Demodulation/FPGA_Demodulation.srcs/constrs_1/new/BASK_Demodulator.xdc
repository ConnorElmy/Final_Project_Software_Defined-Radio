...
## Pmod Header JA
## char_out[7:0] on JA Pmod header (pins ja[0] to ja[7])
## Connect a logic analyser here to read decoded ASCII bytes
set_property -dict { PACKAGE_PIN J2  IOSTANDARD LVCMOS33 } [get_ports { char_out[0] }]; #ja[1]
set_property -dict { PACKAGE_PIN H2  IOSTANDARD LVCMOS33 } [get_ports { char_out[1] }]; #ja[2]
set_property -dict { PACKAGE_PIN H4  IOSTANDARD LVCMOS33 } [get_ports { char_out[2] }]; #ja[3]
set_property -dict { PACKAGE_PIN F3  IOSTANDARD LVCMOS33 } [get_ports { char_out[3] }]; #ja[4]
set_property -dict { PACKAGE_PIN H3  IOSTANDARD LVCMOS33 } [get_ports { char_out[4] }]; #ja[7]
set_property -dict { PACKAGE_PIN H1  IOSTANDARD LVCMOS33 } [get_ports { char_out[5] }]; #ja[8]
set_property -dict { PACKAGE_PIN G1  IOSTANDARD LVCMOS33 } [get_ports { char_out[6] }]; #ja[9]
set_property -dict { PACKAGE_PIN F4  IOSTANDARD LVCMOS33 } [get_ports { char_out[7] }]; #ja[10]
...
set_property -dict { PACKAGE_PIN M4    IOSTANDARD LVCMOS33 } [get_ports { mcp_miso }]; #IO_L19P_T3_34 Sch=pio[02]
...
set_property -dict { PACKAGE_PIN N3    IOSTANDARD LVCMOS33 } [get_ports { mcp_cs }]; #IO_L21N_T3_DQS_34 Sch=pio[07]
#set_property -dict { PACKAGE_PIN P1    IOSTANDARD LVCMOS33 } [get_ports { spi_mosi }]; #IO_L22P_T3_34 Sch=pio[08]
#set_property -dict { PACKAGE_PIN N1    IOSTANDARD LVCMOS33 } [get_ports { spi_mosi }]; #IO_L22N_T3_34 Sch=pio[09] DONE........
#set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { serial_data_out }]; #IO_L11P_T1_SRCC_14 Sch=pio[16]
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { sample_tick_out }]; #IO_L11N_T1_SRCC_14 Sch=pio[17]
set_property -dict { PACKAGE_PIN N13   IOSTANDARD LVCMOS33 } [get_ports { mcp_sck }]; #IO_L8N_T1_D12_14 Sch=pio[18]
set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports { bit_pulse_out }]; #IO_L10N_T1_D15_14 Sch=pio[19]
#set_property -dict { PACKAGE_PIN N14   IOSTANDARD LVCMOS33 } [get_ports { dac_ldac }]; #IO_L10P_T1_D14_14 Sch=pio[20] DONE.......
...
#set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS33 } [get_ports { chip_select }]; #IO_L4N_T0_D05_14 Sch=pio[23] DONE..........
#set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports { pio26 }]; #IO_L7N_T1_D10_14 Sch=pio[26]
set_property -dict { PACKAGE_PIN K14   IOSTANDARD LVCMOS33 } [get_ports { char_valid }]; #IO_L4P_T0_D04_14 Sch=pio[27]
#set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { pio28 }]; #IO_L5P_T0_D06_14 Sch=pio[28]
set_property -dict { PACKAGE_PIN L13   IOSTANDARD LVCMOS33 } [get_ports { bit_out }]; #IO_L7P_T1_D09_14 Sch=pio[29]
#set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { char_out }]; #IO_L8P_T1_D11_14 Sch=pio[30]
#set_property -dict { PACKAGE_PIN J11   IOSTANDARD LVCMOS33 } [get_ports { pio31 }]; #IO_0_14 Sch=pio[31]
#set_property -dict { PACKAGE_PIN C5    IOSTANDARD LVCMOS33 } [get_ports { pin40_clk }]; #IO_L5P_T0_34 Sch=pio[40]
